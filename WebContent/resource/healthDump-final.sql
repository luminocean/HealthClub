...
INSERT INTO `event` VALUES (1,'肌肉撕裂之日！','专业健身教练带来的爆发式肌肉训练课程！逃跑是不允许的！','\0'),(2,' 我们不用很麻烦很累就可以放松','零基础瑜伽课程 妈妈再也不用担心我的健康！','\0'),(3,'我想起了那天夕阳下的奔跑','5000米长跑训练 附赠人身意外保险','\0'),(4,' 放弃的话比赛就结束了哦','为期三周的专业实战训练课程 ','\0'),(5,' 体重大作战','以科学健康的方式达到你理想的体重（一点也不轻松）','');
...
-- Dump completed on 2014-03-18 14:08:46
