...
INSERT INTO `event` VALUES (1,'肌肉撕裂之日！','专业健身教练带来的爆发式肌肉训练课程！逃跑是不允许的！','\0'),(2,' 我们不用很麻烦很累就可以放松','零基础瑜伽课程 妈妈再也不用担心我的健康！','\0'),(3,'我想起了那天夕阳下的奔跑','5000米长跑训练 附赠人身意外保险!','\0'),(4,' 放弃的话比赛就结束了哦','为期三周的专业实战训练课程 ','\0'),(5,' 体重大作战','以科学健康的方式达到你理想的体重（一点也不轻松）',''),(13,'hahah','fgfgfg','\0');
...
INSERT INTO `occasion` VALUES (1,'2014-04-23 14:05:10',1,1,1),(2,'2014-04-26 16:05:10',1,1,2),(3,'2014-05-04 14:05:10',1,2,3),(4,'2014-04-23 14:05:10',2,3,4),(5,'2014-04-26 16:05:10',2,4,5),(6,'2014-05-04 14:05:10',2,1,6),(7,'2014-04-23 14:05:10',3,6,5),(8,'2014-04-26 16:05:10',3,4,4),(9,'2014-05-04 14:05:10',3,5,3),(10,'2014-04-23 14:05:10',4,8,2),(11,'2014-04-26 16:05:10',4,8,1),(12,'2014-05-04 14:05:10',4,4,1),(13,'2014-02-26 16:05:10',5,6,4),(14,'2014-01-04 14:05:10',5,1,2),(16,'2014-06-13 13:00:44',13,3,2);
...
CREATE TABLE `payment` (
  ...
  CONSTRAINT `FKD11C320671F31D9F` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `reserve` VALUES (1,13),(2,14),(5,14),(2,18),(3,20);
...
INSERT INTO `staff` VALUES (1,'servant@servant.com','s',0),(2,'manager@manager.com','m',1);
...
INSERT INTO `tag` VALUES (1,'健身'),(2,'瑜伽'),(3,'有氧'),(3,'跑步'),(4,'篮球'),(5,'健身'),(5,'有氧'),(13,'fgrg'),(13,'sdfsd');
...
INSERT INTO `user` VALUES (11,'haha@ha.com','haha','haha',0,'TFARGB3',0),(12,'kang@kang.com','Kang','k',2,'HKEW41Z',1),(13,'single@single.com','Single','s',0,'QUPZK5I',0),(14,'allen@allen.com','Allen','a',0,'24XFTNP',0),(16,'smith@smith.com','smith','s',0,'V76RB6G',1),(18,'family@family.com','Family','f',0,'4HMQLR0',1),(19,'microcosmos17@163.com','NAME','123',1,'3KLNRHY',0),(20,'test@test.com','Test','t',0,'6JBRQ5S',1),(21,'390333157@ww.com','Qwe','qwe',1,'EY66Z1T',0);
...
INSERT INTO `user_detail` VALUES (1,14,'haha','ha',11,0),(2,12,'sssTown','sss',12,0),(3,15,'ggeVally','gge',12,1),(4,12,'LongBeach','long',12,0),(5,30,'青森','森够',13,1),(6,25,'特罗斯特区','艾伦',14,0),(7,31,'LA','Ruby',16,1),(8,30,'LA','Sandy',16,1),(9,34,'HE','Sandy',18,0),(10,7,'HE','dota',18,0),(11,16,'HE','dora',18,1),(12,36,'HE','kara',18,0),(13,16,'EARTH','NAME',19,1),(14,55,'TT','T1',20,0),(15,55,'TT','T2',20,1),(16,5,'Vvvvv','Huguenot',21,1);
...
-- Dump completed on 2014-05-18 19:37:52
